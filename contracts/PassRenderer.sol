...
contract PassRenderer is Ownable {
        ...
        returns (string memory)
    {
        ...
        return Base64.encode(bytes(abi.encodePacked(
            ...
            '<stop offset="0%" style="stop-color:#3e0047" />',
            '<stop offset="37%" style="stop-color:#420071" />',
            '<stop offset="48%" style="stop-color:#6100a0" />',
            '<stop offset="50%" style="stop-color:#9600f6" />',
            '<stop offset="52%" style="stop-color:#6100a0" />',
            '<stop offset="63%" style="stop-color:#330056" />',
            '<stop offset="100%" style="stop-color:#25003e" />',
            '</linearGradient>',
            '<linearGradient id="grad_refl" x1="50%" y1="0%" x2="50%" y2="100%">',
            '<stop offset="0%" style="stop-color:#3c0066" />',
            ...
            '<text x="340" y="130" text-anchor="end" fill="#fff" font-size="8px" font-family="sans-serif">Polygon</text>',
